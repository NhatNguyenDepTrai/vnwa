<template>
    <div class="flex items-center w-full  mb-3 ">
        <div class="relative w-full mr-3 formkit-field">
            ...
            <input id="inputImage" v-model="url_image" class="formkit-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="email_address" aria-label="Email Address" placeholder="Đường dẫn ảnh" required="" type="email">
        </div>
