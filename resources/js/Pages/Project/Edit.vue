    ...
    <AppLayout title="SửaDự Án">
        ...
        <div class="overflow-hidden  px-5 mb-3 ">
            <div class="w-100  p-1 flex justify-between items-center">
                <div class="  ">
                    <Link :href="route('Project')" class="text-dark-700 hover:text-purple-900 font-bold underline decoration-1">
                ...
                <div class="grid grid-cols-12 relative">
                    ...
                    <div class="col-span-6 p-2">
                        <div class="mb-3">
                            ...
                            <label for="name" class="block mb-2 font-bold text-base text-gray-900 dark:text-dark">Danh mục dự án</label>
                            <select v-model="id_category_project" class="bg-gray-50 border text-base border-gray-300 text-gray-900  rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-full p-2.5 dark:bg-white-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-purple-500 dark:focus:border-purple-500">
                                <option value="">Chọn danh mục dự án</option>
                                <option v-for="item in dataCategoryProject" :value="item.id">{{ item.name }}</option>

                            </select>
                            <span class="text-red-600 text-xs" ref="scroll_id_category_project">{{ error.id_category_project }}</span>
...
export default {
    ...
    setup() {
        ...
        const dataCategoryProject = ref([]);
        dataCategoryProject.value = data.props.dataCategoryProject;

        const id_category_project = data.props.data.id_category_project;
        return {
            ...
            meta_desc,
            list_image,
            dataCategoryProject, id_category_project
        }
    },
